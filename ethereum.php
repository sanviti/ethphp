...
/**
 * Ethereum PHP interface via JSON-RPC
 *
 * See Ethereum Wiki Json-RPC for more information:
 * https://github.com/ethereum/wiki/wiki/JSON-RPC#json-rpc-methods
 * v0.0.1	 fulfill basic function of Ethereum
 * todo:
 * v0.0.2  to finish more feature like checking.
 * v0.0.3  to finish new Ethereum interface like Whisper, Swarm.
 */
...
class Ethereum extends JSON_RPC
{
	...
	private function decode_hex($input) {
		...
		if(preg_match('/[a-f0-9]+/', $input))
			return hexdec($input);	// hexdec()会忽略它遇到的任意非十六进制的字符。
